...
st.title("🔬 Цифровой двойник Fed-Batch культивирования клеток CHO")
st.markdown("Динамическая In silico модель процесса биосинтеза леканемаба с учетом массопередачи O₂ и дробной подпитки.")
